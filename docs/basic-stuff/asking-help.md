...
!!! info
    The `<name>` is the configured name of your bot, when you used [created the bot](/getting-started/bot-loading/#1-bot-scope)

## Where to ask?

The best place for asking help is the [Discord server]({{ discord }}). Go into the [`#support`](https://discord.com/channels/818182471140114432/955054375468924979) channel and ask your question **with the requirements**.
